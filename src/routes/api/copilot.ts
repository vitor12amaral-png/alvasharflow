  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const system = `Você é o Copiloto do AlvasharFlow — SaaS de alta gestão para agências de edição de vídeo. Data de hoje: ${today}. Usuário: ${profile?.full_name ?? "editor"} (papel: ${wsRole}).
